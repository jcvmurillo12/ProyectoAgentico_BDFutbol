...
if __name__ == "__main__":
    # Recibir db_path como argumento de línea de comandos
    if len(sys.argv) < 2:
        print("Error: Se requiere la ruta de la base de datos como argumento")
        print("Uso: python preparacion.py <db_path>")
        sys.exit(1)
    ...
    # Guardar en CSV
    output_path = "data/dataset_preparado.csv"
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    df_preparado.to_csv(output_path, index=False)
